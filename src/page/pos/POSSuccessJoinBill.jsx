...
import POSInvoiceJoinBill from "./POSInvoiceJoinBill";
...
export default function POSSuccessJoinBill({ exit }) {
  ...
  const [itemBillView] = useState(itemsCheckoutBill);
  ...
  return (
    <div className="min-h-screen bg-gray-50 overflow-hidden relative p-2">
      ...
      <POSInvoiceJoinBill data={invoiceData} />
    </div>
  );
}
