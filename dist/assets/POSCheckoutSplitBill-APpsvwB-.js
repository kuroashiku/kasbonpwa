...
function POSCheckoutBill() {
  ...
  const [splitBillArray, setSplitBillArray] = reactExports.useState(["Bill-1", "Bill-2", "Bill-3", "Bill-4", "Bill-5"]);
  const [checkHeight, setCheckHeight] = reactExports.useState([]);
  const [checkWidth, setCheckWidth] = reactExports.useState(0);
  const [pajakBill, setPajakBill] = reactExports.useState([]);
  ...
  const initItems = reactExports.useCallback(
    ...
    ({ itemsCheckout: itemsCheckout2 = [], diskonGlobal: diskonGlobal2 = 0, pajakGlobal: pajakGlobal2 = 0, newItemCheckout = [] }) => {
      let _totalQty = 0;
      let _totalPrice = 0;
      ...
      splitBillArray.map((i, index) => {
        ...
        let splitTotal = 0;
        let totalNew = 0;
        itemsCheckout2.map((_item) => {
          if (_item.split_bill === i) {
            splitCheckouts.push(_item);
            console.log(pajakGlobal2);
            totalNew = totalNew + _item.total;
            _item.total = _item.total * (1 - parseInt(diskonGlobal2 == "" ? 0 : diskonGlobal2) / 100) + _item.total * (1 - parseInt(diskonGlobal2 == "" ? 0 : diskonGlobal2) / 100) * (parseInt(pajakGlobal2) / 100);
        ...
        if (splitCheckouts.length > 0) {
          ...
          totalPriceBill2.push(totalNew);
          totalBill.push(i);
          pajakBillNew.push({ bill: i, value: totalNew * (1 - parseInt(diskonGlobal2 == "" ? 0 : diskonGlobal2) / 100) * (parseInt(pajakGlobal2) / 100) });
          pajakBillNew2.push({ bill: i, value: totalNew * (1 - parseInt(diskonGlobal2 == "" ? 0 : diskonGlobal2) / 100) * (parseInt(pajakGlobal2) / 100) });
        }
      });
      if (pajakGlobal2 > 0)
      ...
      setBill(totalBill);
      setTotalPriceBill(totalPriceBill2);
  ...
  const handleCalculator = reactExports.useCallback(() => {
    ...
    if (diskonGlobal == "")
      setDiskonGlobal(0);
    cookies.role_update.length == 0 && cookies.role_dst.length == 0 ? navigate(topic.cashier.calculator_splitbill.route) : cookies.role_dst.findIndex((a) => a == "ALL") >= 0 ? navigate(topic.cashier.calculator_splitbill.route) : cookies.role_update.findIndex((a) => a == "POS") >= 0 ? navigate(topic.cashier.calculator_splitbill.route) : null;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-screen-adapt bg-gray-50 overflow-hidden relative", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full mx-auto px-2 py-20 overflow-hidden overflow-y-auto lg:flex lg:gap-3 lg:justify-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        react.List,
        {
          className: `item-list ${tmpHeight ? "" : "mobile:max-h-[350px] overflow-y-auto"} lg:h-full lg:overflow-y-auto divide-y divide-dashed divide-gray-400 lg:w-[30%] lg:px-0`,
          children: [
            itemsCheckout.map((i, index) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2 flex flex-col gap-2 bg-light-blue-50 rounded-md", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(react.ListItem, { className: "relative min-h-[88px] lg:min-h-[80px] bg-light-blue-50 overflow-x-hidden pb-3", children: [
                  ...
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      react.Select,
                      {
                        ...
                        children: splitBillArray.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(react.Option, { value: p, children: p }, p))
                      }
                    )
                  }
                )
              ...
              (j, jindex) => {
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(react.ListItem, { className: "", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2 p-1 w-full", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-2 text-", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("b", { children: [
                      pajakGlobalJSON.paj_nama,
                      " ",
                      j.bill
                    ] }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "", children: `${pajakGlobal}%` }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-right", children: formatThousandSeparator(j.value) })
                  ] }),
