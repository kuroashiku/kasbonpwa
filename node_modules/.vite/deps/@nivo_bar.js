...
var withAnimated = (Component, host6) => {
  const hasInstance = (
...
var createHost = (components, {
  ...
  const animated6 = (Component) => {
    const displayName = getDisplayName(Component) || "Anonymous";
    if (is.str(Component)) {
      Component = animated6[Component] || (animated6[Component] = withAnimated(Component, hostConfig));
    } else {
  ...
  eachProp(components, (Component, key) => {
    ...
    animated6[key] = animated6(Component);
  });
  return {
    animated: animated6
  };
...
function v() {
  return v = Object.assign ? Object.assign.bind() : function(t9) {
    for (var i5 = 1; i5 < arguments.length; i5++) {
      var o4 = arguments[i5];
      for (var n6 in o4)
        Object.prototype.hasOwnProperty.call(o4, n6) && (t9[n6] = o4[n6]);
    }
    return t9;
...
function genericArray(a5, b5) {
  ...
  for (i5 = 0; i5 < na; ++i5)
    x6[i5] = value_default(a5[i5], b5[i5]);
  for (; i5 < nb; ++i5)
    c9[i5] = b5[i5];
  return function(t9) {
    for (i5 = 0; i5 < na; ++i5)
...
function string_default(a5, b5) {
  ...
  return s4.length < 2 ? q4[0] ? one(q4[0].x) : zero(b5) : (b5 = q4.length, function(t9) {
    for (var i6 = 0, o4; i6 < b5; ++i6)
      s4[(o4 = q4[i6]).i] = o4.x(t9);
    return s4.join("");
  });
}
...
function decompose_default(a5, b5, c9, d3, e11, f3) {
  ...
  if (scaleX = Math.sqrt(a5 * a5 + b5 * b5))
    a5 /= scaleX, b5 /= scaleX;
  if (skewX = a5 * c9 + b5 * d3)
    c9 -= a5 * skewX, d3 -= b5 * skewX;
...
var isValueIdentity2 = (value, id) => is.arr(value) ? value.every((v6) => isValueIdentity2(v6, id)) : is.num(value) ? value === id : parseFloat(value) === id;
var AnimatedStyle2 = class extends AnimatedObject {
  constructor({ x: x6, y: y4, z: z5, ...style }) {
    ...
    if (x6 || y4 || z5) {
      inputs.push([x6 || 0, y4 || 0, z5 || 0]);
      transforms.push((xyz) => [
        `translate3d(${xyz.map((v6) => addUnit2(v6, "px")).join(",")})`,
        // prettier-ignore
      ...
      if (key === "transform") {
        ...
        transforms.push(
          key === "rotate3d" ? ([x22, y22, z22, deg]) => [
            ...
            `${key}(${input.map((v6) => addUnit2(v6, unit2)).join(",")})`,
...
function formatDecimalParts(x6, p5) {
  if ((i5 = (x6 = p5 ? x6.toExponential(p5 - 1) : x6.toExponential()).indexOf("e")) < 0)
    return null;
...
function formatTrim_default(s4) {
  out:
    for (var n6 = s4.length, i5 = 1, i0 = -1, i1; i5 < n6; ++i5) {
      switch (s4[i5]) {
        case ".":
          i0 = i1 = i5;
          break;
...
function locale_default(locale3) {
  ...
  function formatPrefix2(specifier, value) {
    var f3 = newFormat((specifier = formatSpecifier(specifier), specifier.type = "f", specifier)), e11 = Math.max(-8, Math.min(8, Math.floor(exponent_default(value) / 3))) * 3, k7 = Math.pow(10, -e11), prefix2 = prefixes3[8 + e11 / 3];
    ...
    return function(date2) {
      ...
      while (++i5 < n6) {
        if (specifier.charCodeAt(i5) === 37) {
          ...
          if ((pad2 = pads[c9 = specifier.charAt(++i5)]) != null)
  ...
  function parseSpecifier(d3, specifier, string, j5) {
    ...
    while (i5 < n6) {
      ...
      if (c9 === 37) {
        ...
        if (!parse || (j5 = parse(d3, string, j5)) < 0)
          return -1;
...
function colors_default(specifier) {
  ...
  while (i5 < n6)
    colors3[i5] = "#" + specifier.slice(i5 * 6, ++i5 * 6);
  return colors3;
}
...
function controlPoints(x6) {
  ...
  for (i5 = 1; i5 < n6 - 1; ++i5)
    a5[i5] = 1, b5[i5] = 4, r5[i5] = 4 * x6[i5] + 2 * x6[i5 + 1];
  a5[n6 - 1] = 2, b5[n6 - 1] = 7, r5[n6 - 1] = 8 * x6[n6 - 1] + x6[n6];
  for (i5 = 1; i5 < n6; ++i5)
    m5 = a5[i5] / b5[i5 - 1], b5[i5] -= m5, r5[i5] -= m5 * r5[i5 - 1];
  a5[n6 - 1] = r5[n6 - 1] / b5[n6 - 1];
  for (i5 = n6 - 2; i5 >= 0; --i5)
    a5[i5] = (r5[i5] - a5[i5 + 1]) / b5[i5];
  b5[n6 - 1] = (x6[n6] + a5[n6 - 1]) / 2;
  for (i5 = 0; i5 < n6 - 1; ++i5)
    b5[i5] = 2 * x6[i5 + 1] - a5[i5 + 1];
  return [a5, b5];
}
...
function wiggle_default(series, order) {
  if (!((n6 = series.length) > 0) || !((m5 = (s0 = series[order[0]]).length) > 0))
    return;
...
function jr() {
  return jr = Object.assign ? Object.assign.bind() : function(e11) {
    for (var r5 = 1; r5 < arguments.length; r5++) {
      var t9 = arguments[r5];
      for (var n6 in t9)
        Object.prototype.hasOwnProperty.call(t9, n6) && (e11[n6] = t9[n6]);
    }
    return e11;
...
function Br(e11, r5) {
  ...
  for (n6 = 0; n6 < o4.length; n6++)
    t9 = o4[n6], r5.indexOf(t9) >= 0 || (i5[t9] = e11[t9]);
  return i5;
}
...
var yn = function(e11) {
  ...
  return (0, import_jsx_runtime2.jsxs)(animated2.g, { transform: _3.transform, style: { pointerEvents: "none" }, children: [(0, import_react16.createElement)(i5, { size: o4, color: a5, datum: l3, borderWidth: d3, borderColor: u3 }), c9 && (0, import_jsx_runtime2.jsx)("text", { textAnchor: p5, y: g5, style: Mt(b5.dots.text), children: c9 })] });
};
...
var isValueIdentity3 = (value, id) => is.arr(value) ? value.every((v6) => isValueIdentity3(v6, id)) : is.num(value) ? value === id : parseFloat(value) === id;
var AnimatedStyle3 = class extends AnimatedObject {
  constructor({ x: x6, y: y4, z: z5, ...style }) {
    ...
    if (x6 || y4 || z5) {
      inputs.push([x6 || 0, y4 || 0, z5 || 0]);
      transforms.push((xyz) => [
        `translate3d(${xyz.map((v6) => addUnit3(v6, "px")).join(",")})`,
        // prettier-ignore
      ...
      if (key === "transform") {
        ...
        transforms.push(
          key === "rotate3d" ? ([x22, y22, z22, deg]) => [
            ...
            `${key}(${input.map((v6) => addUnit3(v6, unit2)).join(",")})`,
...
var kn2 = function(n6, t9) {
  ...
  if ("ticks" in n6) {
    if (void 0 === t9)
      return n6.ticks();
    if ("number" == typeof (m5 = t9) && isFinite(m5) && Math.floor(m5) === m5)
      return n6.ticks(t9);
  }
  var m5;
  return n6.domain();
...
var A3 = (0, import_react17.memo)(function(t9) {
  ...
  return (0, import_jsx_runtime3.jsxs)(animated3.g, p2({ transform: x6.transform }, b5, { children: [(0, import_jsx_runtime3.jsx)("line", { x1: 0, x2: a5, y1: 0, y2: s4, style: y4 }), h2.outlineWidth > 0 && (0, import_jsx_runtime3.jsx)(animated3.text, { dominantBaseline: u3, textAnchor: d3, transform: x6.textTransform, style: h2, strokeWidth: 2 * h2.outlineWidth, stroke: h2.outlineColor, strokeLinejoin: "round", children: "" + v6 }), (0, import_jsx_runtime3.jsx)(animated3.text, { dominantBaseline: u3, textAnchor: d3, transform: x6.textTransform, style: Mt(h2), children: "" + v6 })] }));
});
var S = function(e11) {
  ...
  return (0, import_jsx_runtime3.jsxs)(animated3.g, { transform: nt2.transform, "aria-hidden": L4, children: [ot2(function(e12, i5, n6, r6) {
  ...
  }), (0, import_jsx_runtime3.jsx)(animated3.line, { style: N3.axis.domain.line, x1: 0, x2: nt2.lineX2, y1: 0, y2: nt2.lineY2 }), Q3] });
};
...
var X2 = (0, import_react17.memo)(function(t9) {
  ...
  return (0, import_jsx_runtime3.jsx)(animated3.line, p2({}, e11, i5.grid.line));
});
...
var isValueIdentity4 = (value, id) => is.arr(value) ? value.every((v6) => isValueIdentity4(v6, id)) : is.num(value) ? value === id : parseFloat(value) === id;
var AnimatedStyle4 = class extends AnimatedObject {
  constructor({ x: x6, y: y4, z: z5, ...style }) {
    ...
    if (x6 || y4 || z5) {
      inputs.push([x6 || 0, y4 || 0, z5 || 0]);
      transforms.push((xyz) => [
        `translate3d(${xyz.map((v6) => addUnit4(v6, "px")).join(",")})`,
        // prettier-ignore
      ...
      if (key === "transform") {
        ...
        transforms.push(
          key === "rotate3d" ? ([x22, y22, z22, deg]) => [
            ...
            `${key}(${input.map((v6) => addUnit4(v6, unit2)).join(",")})`,
...
var isValueIdentity5 = (value, id) => is.arr(value) ? value.every((v6) => isValueIdentity5(v6, id)) : is.num(value) ? value === id : parseFloat(value) === id;
var AnimatedStyle5 = class extends AnimatedObject {
  constructor({ x: x6, y: y4, z: z5, ...style }) {
    ...
    if (x6 || y4 || z5) {
      inputs.push([x6 || 0, y4 || 0, z5 || 0]);
      transforms.push((xyz) => [
        `translate3d(${xyz.map((v6) => addUnit5(v6, "px")).join(",")})`,
        // prettier-ignore
      ...
      if (key === "transform") {
        ...
        transforms.push(
          key === "rotate3d" ? ([x22, y22, z22, deg]) => [
            ...
            `${key}(${input.map((v6) => addUnit5(v6, unit2)).join(",")})`,
...
function g3() {
  return g3 = Object.assign ? Object.assign.bind() : function(t9) {
    for (var n6 = 1; n6 < arguments.length; n6++) {
      var i5 = arguments[n6];
      for (var o4 in i5)
        Object.prototype.hasOwnProperty.call(i5, o4) && (t9[o4] = i5[o4]);
    }
    return t9;
...
var O4 = function(t9) {
  ...
  if ((0, import_isNumber.default)(r5))
    n6 = o4 + r5;
  else {
    if (void 0 === r5.abs)
  ...
  if ((0, import_isNumber.default)(s4))
    i5 = a5 + s4;
  else {
    if (void 0 === s4.abs)
...
var T3 = function(t9) {
  ...
  return "function" == typeof r5 ? (0, import_react18.createElement)(r5, { x: o4, y: e11, datum: n6 }) : (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [s4.annotations.text.outlineWidth > 0 && (0, import_jsx_runtime4.jsx)(animated5.text, { x: k7.x, y: k7.y, style: g3({}, s4.annotations.text, { strokeLinejoin: "round", strokeWidth: 2 * s4.annotations.text.outlineWidth, stroke: s4.annotations.text.outlineColor }), children: r5 }), (0, import_jsx_runtime4.jsx)(animated5.text, { x: k7.x, y: k7.y, style: (0, import_omit.default)(s4.annotations.text, ["outlineWidth", "outlineColor"]), children: r5 })] });
};
var E3 = function(t9) {
  ...
  if (e11 && a5.annotations.link.outlineWidth <= 0)
    return null;
  var l3 = g3({}, a5.annotations.link);
  return e11 && (l3.strokeLinecap = "square", l3.strokeWidth = a5.annotations.link.strokeWidth + 2 * a5.annotations.link.outlineWidth, l3.stroke = a5.annotations.link.outlineColor, l3.opacity = a5.annotations.link.outlineOpacity), (0, import_jsx_runtime4.jsx)(animated5.path, { fill: "none", d: s4, style: l3 });
};
var I = function(t9) {
  ...
  return (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [e11.annotations.outline.outlineWidth > 0 && (0, import_jsx_runtime4.jsx)(animated5.circle, { cx: l3.x, cy: l3.y, r: l3.radius, style: g3({}, e11.annotations.outline, { fill: "none", strokeWidth: e11.annotations.outline.strokeWidth + 2 * e11.annotations.outline.outlineWidth, stroke: e11.annotations.outline.outlineColor, opacity: e11.annotations.outline.outlineOpacity }) }), (0, import_jsx_runtime4.jsx)(animated5.circle, { cx: l3.x, cy: l3.y, r: l3.radius, style: e11.annotations.outline })] });
};
var D2 = function(t9) {
  ...
  return (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [a5.annotations.outline.outlineWidth > 0 && (0, import_jsx_runtime4.jsx)(animated5.circle, { cx: u3.x, cy: u3.y, r: u3.radius, style: g3({}, a5.annotations.outline, { fill: "none", strokeWidth: 2 * a5.annotations.outline.outlineWidth, stroke: a5.annotations.outline.outlineColor, opacity: a5.annotations.outline.outlineOpacity }) }), (0, import_jsx_runtime4.jsx)(animated5.circle, { cx: u3.x, cy: u3.y, r: u3.radius, style: a5.annotations.symbol })] });
};
var L2 = function(t9) {
  ...
  return (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [s4.annotations.outline.outlineWidth > 0 && (0, import_jsx_runtime4.jsx)(animated5.rect, { x: k7.x, y: k7.y, rx: r5, ry: r5, width: k7.width, height: k7.height, style: g3({}, s4.annotations.outline, { fill: "none", strokeWidth: s4.annotations.outline.strokeWidth + 2 * s4.annotations.outline.outlineWidth, stroke: s4.annotations.outline.outlineColor, opacity: s4.annotations.outline.outlineOpacity }) }), (0, import_jsx_runtime4.jsx)(animated5.rect, { x: k7.x, y: k7.y, rx: r5, ry: r5, width: k7.width, height: k7.height, style: s4.annotations.outline })] });
};
var R = function(t9) {
...
function qe() {
  return qe = Object.assign ? Object.assign.bind() : function(e11) {
    for (var r5 = 1; r5 < arguments.length; r5++) {
      var n6 = arguments[r5];
      for (var t9 in n6)
        Object.prototype.hasOwnProperty.call(n6, t9) && (e11[t9] = n6[t9]);
    }
    return e11;
...
function Ge(e11, r5) {
  ...
  if (n6)
    return (n6 = n6.call(e11)).next.bind(n6);
  ...
  if ((0, import_isPlainObject2.default)(e11)) {
    ...
    if (function(e12) {
      ...
      if (Array.isArray(e11.modifiers)) {
        ...
        }, a5 = Ge(e11.modifiers); !(o4 = a5()).done; )
          u3();
...
var x4 = function(t9) {
  ...
  if ("number" != typeof o4 && ("object" != typeof (e11 = o4) || Array.isArray(e11) || null === e11))
...
function j4() {
  return j4 = Object.assign ? Object.assign.bind() : function(e11) {
    for (var t9 = 1; t9 < arguments.length; t9++) {
      var a5 = arguments[t9];
      for (var i5 in a5)
        Object.prototype.hasOwnProperty.call(a5, i5) && (e11[i5] = a5[i5]);
    }
    return e11;
...
function q3(e11, t9) {
  ...
  for (i5 = 0; i5 < l3.length; i5++)
    a5 = l3[i5], t9.indexOf(a5) >= 0 || (n6[a5] = e11[a5]);
  return n6;
}
var K3;
var _2 = function(e11) {
...
var Ve2 = function(e11) {
  ...
  return useTransition(t9, { keys: function(e12) {
    ...
    return (0, import_jsx_runtime6.jsx)(animated4.text, { x: e12.x, y: e12.y, fillOpacity: e12.labelOpacity, style: j4({}, o4.labels.text, { pointerEvents: "none", fill: o4.text.fill }), fontWeight: "bold", fontSize: o4.labels.text.fontSize, fontFamily: o4.labels.text.fontFamily, textAnchor: "vertical" === r5 ? "middle" : "start", alignmentBaseline: "vertical" === r5 ? "alphabetic" : "middle", children: t10.formattedValue }, t10.key);
  });
};
